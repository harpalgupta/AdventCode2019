...
{
    [TestFixture]
    public class Day5_1202ProgramAlarmTests
    {
        ...
        {
            int[] instructions = {11105, 1, 3, 11101, 0, 1, 0, 99};
            Assert.AreEqual(new[] {11105, 1, 3, 11101, 0, 1, 1, 99}, _program.ProcessInstructions(instructions));
        }

        [Test]
        public void Outputs0WhenNotEqualToDay5Part2()
        {
        ...
        [Test]
        public void Outputs1WhenLessThan()
        {
        ...
        public void Day5TestPart2Result()
        {
            ...
            //13787043 too high
            //3892695 correct
            Assert.AreEqual(3892695, _program.GetOutputValue());
        }
    }
}