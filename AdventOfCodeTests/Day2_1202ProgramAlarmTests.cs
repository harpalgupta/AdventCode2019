...
namespace AdventOfCode2019
{
    ...
    public class Day2_1202ProgramAlarmTests
    {
        ...
        [Test]
        public void ParameterModeWithOpCode5_SkipsToInstructionAtParam2()
        {
            int[] instructions = { 11105, 1, 11101, 1, 0, 0, 99 };
            Assert.AreEqual(new[] { 11105, 1, 11101, 1, 0, 1, 99 }, _program.ProcessInstructions(instructions));
        }

        [Test]
        public void SomeTestsDay5Part2NotEqualTo()
        {
            int[] instructions = { 3, 9, 8, 9, 10, 9, 4, 9, 99, -1, 8 };
            _program.ProcessInstructions(instructions, 1);

            Assert.AreEqual(0, _program.GetOutputValue());
        }
        public void SomeTestsDay5Part2IsLessThan()
        {
            int[] instructions = { 3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8 };
            _program.ProcessInstructions(instructions, 1);

            Assert.AreEqual(1, _program.GetOutputValue());
        }

        [Test]
        [Ignore("")]
        public void Day5TestPart2Result()
        {
            int[] instructions =
            {
                3, 225, 1, 225, 6, 6, 1100, 1, 238, 225, 104, 0, 1102, 9, 19, 225, 1, 136, 139, 224, 101, -17, 224, 224,
            ...
            _program.ProcessInstructions(instructions, 5);
